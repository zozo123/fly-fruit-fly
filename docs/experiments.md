...
The checkpoint includes learned parameters and observation normalization. Keep it with its matching graph. Loading validates sparse wiring and provenance; new checkpoints additionally record and validate neuron IDs. Legacy checkpoints lack explicit neuron IDs. It is a failed research candidate, ready for inspection and continued experimentation.
